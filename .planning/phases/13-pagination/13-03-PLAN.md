...
1. Groups load in pages as you scroll
2. Expanding a group fetches its students
3. Creating a new group invalidates the list
4. Removing a student updates the local state</verify>
