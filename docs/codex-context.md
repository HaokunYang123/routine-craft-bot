...
## Active file: docs/all-realtime-subscriptions.md
...
## Open tabs:
- all-realtime-subscriptions.md: docs/all-realtime-subscriptions.md
- realtime-subscription-exact.md: docs/realtime-subscription-exact.md
- realtime-debug-dump.md: docs/realtime-debug-dump.md
- GroupDetail.tsx: src/pages/GroupDetail.tsx
- PolygonShowcase.tsx: src/pages/PolygonShowcase.tsx

## My request for Codex:
Copy the contents of this context handover into docs/codex-context.md in the repo root. This file should be listed in AGENTS.md as a required read alongside the dev log and restructure plan.
